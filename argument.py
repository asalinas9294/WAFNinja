...
''',formatter_class=RawTextHelpFormatter, version='WAFNinja 1.0')
    ...
    attack_payload_parser.add_argument('--headers',metavar='HEADERS',help='HTTP Request Headers ["Header1:value,Header2:value..."]',required=False)
    ...
    attack_fuzz_parser.add_argument('--headers',metavar='HEADERS',help='HTTP Request Headers ["Header1:value,Header2:value..."]',required=False)
    ...
    if args.mode == 'bypass':
        ...
        if postfix is None:
            postfix = ''
        return ['bypass', url, post, cookie, type, delay, waf, outputFile, headers, proxy, prefix, postfix]
        ...
        if postfix is None:
            postfix = ''
        return ['fuzz', url, post, cookie, type, delay, outputFile, headers, proxy, prefix, postfix] 
